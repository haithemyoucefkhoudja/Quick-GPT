...
from ui.Messanger._MessageUI import QsciScintilla
...
class NeutronLexer(QsciLexerCustom):
    ...
    def _init_theme_vars(self):
        ...
        self.font_weights = {
            "thin": 25,    # QFont.Thin
    "extralight": 12, # Approximation, no exact equivalent
    "light": 50,   # QFont.Light
    "normal": 400, # QFont.Normal
    "medium": 500, # QFont.Medium
    "demibold": 600, # QFont.DemiBold
    "bold": 700,   # QFont.Bold
    "extrabold": 800, # QFont.ExtraBold
    "black": 900  # QFont.Black
}
                    ...
                    try:
                        self.setFont(
                            QFont(
                                ...
                                v.get("font-size", 12),
                                self.font_weights.get(v.get("font-weight", 400)),
                                v.get("italic", False)
                            ),
